// React Native Paper colors passed to theme in app js
export const colorPalette = {
  primary: '#585ce5', // contained button background, primary actions etc
  onPrimary: 'rgb(255, 255, 255)', // contained button text color, primary action text color
  ...
  background: '#fafaff', // outlined textInput background
  onBackground: 'rgb(30, 26, 29)',
  surface: 'rgb(255, 251, 255)',
  onSurface: 'rgb(30, 26, 29)', // text, headline large etc?
  surfaceVariant: '#fafaff', // flat textInput background,
  onSurfaceVariant: 'rgb(78, 68, 75)', // textInput label color
  outline: '#f0f1f9', // textInput outlined outline, maybe too low contrast?
